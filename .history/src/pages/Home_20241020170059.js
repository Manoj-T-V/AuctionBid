...
import homebanner from '../assets/Group 6695.svg'
    ...
    <div className="container">
      {isLoggedIn ? (
        ...
        <PlaceholderImage>
          ...
          <h1 className="page-title" style={{textAlign: 'left', margin:'2% 0% 1% 2%'}}>Explore <span style={{ color: '#235BDB' }}>{localStorage.getItem('name')}</span></h1>
        </PlaceholderImage>
      )}
      <AuctionList>
        {auctions.map((auction) => (
          <AuctionCard key={auction._id}>
            ...
            <p>Ends in: {calculateRemainingTime(auction.endDate)}</p>
