...
{
  _id: ObjectId("6713f4ad7c26e8bf8d71d64f"),
  amount: Number,                 // The amount bid by the user
  bidder: ObjectId("671289c4824f13e4b6f35877"),   // Reference to the user who placed the bid
  auctionItem: ObjectId("67129dc4657ffbdd9f3efd32"),  // Reference to the auction item
