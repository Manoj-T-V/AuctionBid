...
{
  _id: ObjectId("67129dc4657ffbdd9f3efd32"),
  ...
  createdBy: ObjectId("671289c4824f13e4b6f35877"),  // Reference to the user who created the auction
  endDate: Date,                  // Auction end date and time
  bids: Array,                    // Array of bid references
  highestBidder: ObjectId("671289c4824f13e4b6f35877"), // Reference to the current highest bidder
